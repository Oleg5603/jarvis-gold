...
input int    InpHistoryBars   = 100000;           // История в свечах (0=все)
input bool   InpVirtualTF     = true;             // Использовать виртуальный таймфрейм
...
input int   InpA8Size =5;  input color InpA8Color=clrTurquoise;
input bool  InpAlert78=false;

//======================================================
//  STRUCTS & GLOBALS
//======================================================

#define PREFIX       "Sn91c_"
